...
# installed.
TCL_PREFIX='E:/Research_Engineer_Internship_Project_1/Car_Price_Prediction_ML_Project/CarPricePredictionMLModelVenv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='E:/Research_Engineer_Internship_Project_1/Car_Price_Prediction_ML_Project/CarPricePredictionMLModelVenv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='E:/Research_Engineer_Internship_Project_1/Car_Price_Prediction_ML_Project/CarPricePredictionMLModelVenv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IE:/Research_Engineer_Internship_Project_1/Car_Price_Prediction_ML_Project/CarPricePredictionMLModelVenv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LE:/Research_Engineer_Internship_Project_1/Car_Price_Prediction_ML_Project/CarPricePredictionMLModelVenv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='E:/Research_Engineer_Internship_Project_1/Car_Price_Prediction_ML_Project/CarPricePredictionMLModelVenv\Library\lib\tclstub86.lib'
